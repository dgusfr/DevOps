...
Uma vez que os Pods são **efêmeros** (podem ser destruídos e recriados a qualquer momento), seus endereços IP mudam. 

![alt text](images/comunica_cluster.png)

Como fazer para que as aplicações se comuniquem de forma estável? A resposta é o objeto Service.
